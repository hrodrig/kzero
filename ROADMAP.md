...
**Last reviewed:** 2026-07-11 (**v0.9.1** tagged; stretch **#52**–**#53** on `develop`; **#48–#51** remain)
...
| **0.9.x** | **v0.9.0** core shipped (**#43–#47**); **v0.9.1** security patch; stretch **#52**–**#53** done on `develop`; **#48–#51** still open — see [docs/plan-0.9.x.md](docs/plan-0.9.x.md). |
