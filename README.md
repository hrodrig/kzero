...
[![Version](https://img.shields.io/badge/version-0.2.2-blue.svg)](https://github.com/hrodrig/kzero/releases)
...
Use a **release tag** instead of `@latest` if you want a pinned version (for example `@v0.2.2`). Module reference: [pkg.go.dev/github.com/hrodrig/kzero](https://pkg.go.dev/github.com/hrodrig/kzero).
